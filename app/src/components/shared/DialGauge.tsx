...
// Wrap Circle to filter out collapsable prop (leaks to DOM on web)
const FilteredCircle = React.forwardRef<any, any>((props, ref) => {
  const { collapsable, ...rest } = props;
  return <Circle ref={ref} {...rest} />;
});
const AnimatedCircle = Animated.createAnimatedComponent(FilteredCircle);
